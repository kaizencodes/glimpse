...
func ColorAt(w *world.World, r *ray.Ray) color.Color {
...
func intersect(w *world.World, r *ray.Ray) shapes.Intersections {
...
func shadeHit(w *world.World, comps Computations) color.Color {
...
func shadowAt(w *world.World, point tuple.Tuple) bool {
...
func reflectedColor(w *world.World, comps Computations) color.Color {
...
func refractedColor(w *world.World, comps Computations) color.Color {
